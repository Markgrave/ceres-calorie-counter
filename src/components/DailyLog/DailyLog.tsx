...
const DailyLog = () => {
  ...
  return (
    <section className="w-full md:w-3/5 h-full bg-(--bg-secondary) dark:bg-(--dark-bg-secondary) rounded-2xl p-3 shadow-md">
      <div className="flex flex-col justify-between items-center h-full bg-(--bg-secondary) dark:bg-(--dark-bg-tertiary) border-2 border-gray-100 dark:border-gray-700 rounded-2xl p-6 pt-20 md:p-10 shadow-md relative">
